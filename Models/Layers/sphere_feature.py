...
class dist_emb(torch.nn.Module):
    ...
    def forward(self, dist):
        ...
        if torch.isnan(dist).any() or torch.isnan(self.envelope(dist) * (self.freq * dist).sin()).any():
            print(torch.isnan(dist).any(), torch.isnan(self.envelope(dist) * (self.freq * dist).sin()).any())
            print(dist.shape)
            print(torch.isnan(dist).any())
            print(dist)
            print(self.envelope(dist).shape)
            print(f'max: {torch.max(self.envelope(dist))} min: {torch.min(self.envelope(dist))}')
            print(torch.isnan(self.envelope(dist)).any())
            print(self.envelope(dist))
            print((self.freq*dist).sin().shape)
            print(f'max: {torch.max((self.freq*dist).sin())} min: {torch.min((self.freq*dist).sin())}')
            print(torch.isnan((self.freq*dist).sin()).any())
            print((self.freq*dist).sin())
            print('===============================')
            print(self.envelope(dist) * (self.freq * dist).sin())
            raise Exception('nan')
