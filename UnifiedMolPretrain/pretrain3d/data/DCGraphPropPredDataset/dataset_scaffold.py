...
class DCGraphPropPredDatasetScaffold(InMemoryDataset):
    ...
    def process(self):
        ...
        data = pd.read_csv(f'/hy-tmp/molecule/dataset/sider/mapping/mol.csv')
        smiles_list = data['smiles']
        # print(data.keys())
        # labels_list = data['p_np']
        labels_list = data[[key for key in data.keys() if key not in ['mol_id', 'smiles']]].values
